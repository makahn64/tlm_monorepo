...
const logIfLevelLegit = (
  message: string,
  bypassReactotron: boolean,
  level: number,
) => {
  if (level <= logLevel) {
 ...
 */
export const log = (message: string, bypassReactotron = false) => {
...
export const logSilly = (message: string, bypassReactotron = false) =>
  logIfLevelLegit(message, bypassReactotron, LogLevel.silly);

export const logVerbose = (message: string, bypassReactotron = false) =>
  logIfLevelLegit(message, bypassReactotron, LogLevel.verbose);

export const logInfo = (message: string, bypassReactotron = false) =>
  logIfLevelLegit(message, bypassReactotron, LogLevel.info);

export const logWarn = (message: string, bypassReactotron = false) =>
  logIfLevelLegit(message, bypassReactotron, LogLevel.warn);

export const logError = (message: string, bypassReactotron = false) =>
  logIfLevelLegit(message, bypassReactotron, LogLevel.error);

export const logDebug = (message: string, bypassReactotron = false) =>
